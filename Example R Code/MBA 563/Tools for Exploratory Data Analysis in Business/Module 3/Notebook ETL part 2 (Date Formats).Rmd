---
title: "Notebook ETL part 2"
author: "William Kelly"
date: "6/19/2021"
output: html_document
---

Many consider cleaning and exploring data to be the most time-consuming part of a data analysts job. Letâ€™s continue to practice some key techniques for ETL using RStudio.
...
In the prior video we examined each column of our dataset called â€œmooc1â€. In this video, we will clean or tidy that dataset. There are multiple ways that a dataset can be messy, including but not limited to the following:
* Column headers that donâ€™t have names
* Multiple variables stored in one column
* Variables stored in rows and columns
* Outliers, which are extreme valuesâ€”either vary large or vary small
* Mistakes
