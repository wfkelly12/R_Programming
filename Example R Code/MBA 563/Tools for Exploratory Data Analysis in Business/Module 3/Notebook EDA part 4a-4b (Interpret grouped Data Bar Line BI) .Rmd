...
Letâ€™s explore this some more by looking at the percentage change in gross profit margins using another column plot. Notice how easy it is to change variable we are examining from revenue to gross profit margin and the plot a new graph. We just cut and paste and change one word! 
...
Sure enough, if we run another line plot looking at share of gross profit, we see that in 2019, fuel made up the lowest share of 2019â€™s gross profit in three years. 
